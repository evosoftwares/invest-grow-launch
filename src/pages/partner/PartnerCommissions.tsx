    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <Card className="w-full max-w-md">
          <CardHeader>
            <CardTitle className="text-red-600">Erro ao carregar comissões</CardTitle>
            <CardDescription>
              Não foi possível carregar o histórico de comissões. Tente novamente mais tarde.
            </CardDescription>
          </CardHeader>
          <CardContent>
                    ...
                    <div key={commission.id} className="flex items-center justify-between p-4 border rounded-lg bg-white">
                      <div className="flex-1">
                        ...
                        <div className="text-sm text-gray-600">
                          <div>Investimento: R$ {commission.investment_amount.toLocaleString('pt-BR', { minimumFractionDigits: 2 })}</div>
